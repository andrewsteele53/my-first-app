...
export default function ConstructionInvoicePage() {
  ...
  const [invoiceNumber, setInvoiceNumber] = useState(() => createInvoiceNumber("CONST"));
  const [customerName, setCustomerName] = useState("");
  const [phone, setPhone] = useState("");
  const [email, setEmail] = useState("");
  const [address, setAddress] = useState("");
  const [projectTitle, setProjectTitle] = useState("Construction Service");
  ...
  function clearForm() {
    ...
    setEmail("");
    setAddress("");
    setProjectTitle("Construction Service");
    setNotes("");
    setProjectType("");
    setJobLocation("");
    setStartDate("");
    ...
    setPaymentMethod("");
    setPaymentNotes("");
    setItems([{ description: "Labor", quantity: 1, price: 500 }]);
    setMessage("");
    setInvoiceNumber(createInvoiceNumber("CONST"));
  }
          ...
          <section className={invoiceUi.heroCard}>
            <div className="flex flex-col gap-3 border-b border-slate-200 pb-6 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="mt-2 text-3xl font-bold">Construction Invoice</h1>
                <p className="mt-2 text-slate-600">
                  Create clean, professional construction invoices for labor,
                  materials, phases, and project add-ons.
                </p>
              </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Kitchen Remodel, Basement Repair, Framing Job..."
                  className={invoiceUi.input}
                />
              </div>
            </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder="Remodel, repair, framing, drywall..."
                  className={invoiceUi.input}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Inside, exterior, garage, basement..."
                  className={invoiceUi.input}
                />
              </div>
            ...
            <div className="mt-10">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold">Construction Line Items</h2>
                  <p className="mt-1 text-sm text-slate-600">
                    Add labor, materials, phases, hauling, or project extras below.
                  </p>
                </div>
                    ...
                    >
                      <div className="grid gap-4 md:grid-cols-12">
                        <div className="md:col-span-12">
                          ...
                          <input
                            placeholder="Labor, materials, demo, framing, repair, cleanup..."
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Any special scope notes, material details, schedule notes, or customer requests..."
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <InvoiceSaveButton
                ...
                onSaved={() => {
                  setMessage("Construction invoice saved.");
                  setInvoiceNumber(createInvoiceNumber("CONST"));
                }}
          ...
          <aside className="space-y-6">
            ...
            <div className={invoiceUi.card}>
              ...
              <div className="mt-4 space-y-2 text-sm text-slate-600">
                <p>Use separate line items for labor and materials.</p>
                <p>Use additional lines for phases or change orders.</p>
                <p>Add demolition, haul-away, or cleanup as separate billable items.</p>
                <p>Use quantity for hours, days, loads, or material units.</p>
              </div>
            </div>

            <div className={invoiceUi.card}>
              <h2 className="text-2xl font-bold">Popular Construction Items</h2>
              <div className="mt-4 space-y-2 text-sm text-slate-600">
                <p>Labor</p>
                <p>Materials</p>
                <p>Demolition</p>
          ...
          >
            <div className="flex flex-col gap-4 border-b border-slate-300 pb-6 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-bold">Construction Services</h2>
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-2">{projectType || "Project type"}</p>
                <p className="mt-1">{jobLocation || "Job location"}</p>
                <p className="mt-1">Start: {startDate || "-"}</p>
                <p className="mt-1">Completion: {completionDate || "-"}</p>
                <p className="mt-1">Permit Required: {permitRequired || "-"}</p>
                <p className="mt-1">Crew Size: {crewSize || "-"}</p>
              </div>
            </div>
