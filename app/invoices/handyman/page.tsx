...
export default function HandymanInvoicePage() {
  const invoiceRef = useRef<HTMLDivElement>(null);

  const [invoiceNumber, setInvoiceNumber] = useState(() => createInvoiceNumber("HANDY"));
  const [customerName, setCustomerName] = useState("");
  const [phone, setPhone] = useState("");
  const [email, setEmail] = useState("");
  const [address, setAddress] = useState("");
  const [projectTitle, setProjectTitle] = useState("Handyman Service");
  ...
  const [items, setItems] = useState<InvoiceLineItem[]>([
    { description: "General Handyman Labor", quantity: 1, price: 125 },
  ]);
  ...
  function clearForm() {
    ...
    setEmail("");
    setAddress("");
    setProjectTitle("Handyman Service");
    setNotes("");
    setServiceCategory("");
    setJobLocation("");
    setEstimatedHours("");
    ...
    setPaymentMethod("");
    setPaymentNotes("");
    setItems([{ description: "General Handyman Labor", quantity: 1, price: 125 }]);
    setMessage("");
    setInvoiceNumber(createInvoiceNumber("HANDY"));
  }
          ...
          <section className={invoiceUi.heroCard}>
            <div className="flex flex-col gap-3 border-b border-slate-200 pb-6 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="mt-2 text-3xl font-bold">Handyman Invoice</h1>
                <p className="mt-2 text-slate-600">
                  Create clean, professional invoices for repairs, installs,
                  assembly, maintenance, and small project work.
                </p>
              </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Door Repair, Faucet Install, TV Mounting..."
                  className={invoiceUi.input}
                />
              </div>
            </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder="Repair, install, assembly, maintenance..."
                  className={invoiceUi.input}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Kitchen, bathroom, garage, exterior..."
                  className={invoiceUi.input}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Customer, contractor, mixed..."
                  className={invoiceUi.input}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ladder, drill, saw, none..."
                  className={invoiceUi.input}
                />
              </div>
            </div>
            ...
            <div className="mt-10">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold">Handyman Line Items</h2>
                  <p className="mt-1 text-sm text-slate-600">
                    Add labor, materials, install fees, repairs, or add-ons below.
                  </p>
                </div>
                    ...
                    >
                      <div className="grid gap-4 md:grid-cols-12">
                        <div className="md:col-span-12">
                          ...
                          <input
                            placeholder="Labor, repair, install, assembly, parts..."
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Any job notes, parts used, access notes, or customer requests..."
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <InvoiceSaveButton
                ...
                onSaved={() => {
                  setMessage("Handyman invoice saved.");
                  setInvoiceNumber(createInvoiceNumber("HANDY"));
                }}
          ...
          <aside className="space-y-6">
            ...
            <div className={invoiceUi.card}>
              ...
              <div className="mt-4 space-y-2 text-sm text-slate-600">
                <p>Use separate lines for labor and materials.</p>
                <p>Add assembly, repair, or install work as separate billable items.</p>
                <p>Use quantity for hours, fixtures, or completed tasks.</p>
                <p>Keep small add-ons separate so customers can see the value clearly.</p>
              </div>
            </div>

            <div className={invoiceUi.card}>
              <h2 className="text-2xl font-bold">Popular Handyman Services</h2>
              <div className="mt-4 space-y-2 text-sm text-slate-600">
                <p>Drywall patch repair</p>
                <p>Door repair</p>
                <p>Faucet or fixture install</p>
                <p>TV mounting</p>
                <p>Furniture assembly</p>
                <p>Ceiling fan install</p>
                <p>General maintenance labor</p>
              </div>
            </div>
          </aside>
        </div>
          ...
          >
            <div className="flex items-start justify-between border-b border-slate-300 pb-6">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-bold">Handyman Services</h2>
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-500">Job Details</p>
                <p className="mt-2">{serviceCategory || "Service category"}</p>
                <p className="mt-1">Location: {jobLocation || "-"}</p>
                <p className="mt-1">Estimated Hours: {estimatedHours || "-"}</p>
                <p className="mt-1">Completion Date: {completionDate || "-"}</p>
                <p className="mt-1">Materials: {materialsProvided || "-"}</p>
                <p className="mt-1">Special Tools: {specialToolsNeeded || "-"}</p>
              </div>
